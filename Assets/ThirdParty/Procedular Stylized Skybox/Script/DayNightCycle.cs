...
namespace Biostart.DayNight
{
    public class DayNightCycle : MonoBehaviour
    {
        ...
        {
            float totalMinutesInDay = currentTimeOfDay * 1440;
            int hours = Mathf.FloorToInt(totalMinutesInDay / 60);
            int minutes = Mathf.FloorToInt(totalMinutesInDay % 60);
            ...
            if (timeDisplay != null)
            {
                timeDisplay.text = $"{hours:D2}:{minutes:D2} {period}";
            }
        }
